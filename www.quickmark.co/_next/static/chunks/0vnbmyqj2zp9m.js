(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 292721, e => {
    "use strict";
    var t = e.i(768834);
    ...
    let s = (0, t.create)(e => ({
        ...
        showRankedAdmin: !1,
        showRanked: !1,
        questionColorMode: o("questionColorMode", r, "auto"),
        questionInteractionMode: o("questionInteractionMode", n, "inline"),
        flashRevealEnabled: a("flashRevealEnabled"),
        zenModeEnabled: !1,
        wakeLockEnabled: a("wakeLockEnabled"),
        setTheme: t => {
            e({
                theme: t
            }), i("theme", t);
    ...
    let a = {
        ...
        u = (e, t) => {
            ...
            for (let a in e) {
                let i = e[a];
                "@" == a[0] ? "i" == a[1] ? r = a + " " + i + ";" : n += "f" == a[1] ? u(i, a) : a + "{" + u(i, "k" == a[1] ? "" : t) + "}" : "object" == typeof i ? n += u(i, t ? t.replace(/([^,])+/g, e => a.replace(/([^,]*:\S+\([^)]*\))|([^,])+/g, t => /&/.test(t) ? t.replace(/&/g, e) : e ? e + " " + t : t)) : a) : null != i && (a = /^--/.test(a) ? a : a.replace(/[A-Z]/g, "-$&").toLowerCase(), o += u.p ? u.p(a, i) : a + ":" + i + ";")
            }
    ...
    function f(e) {
        ...
        return ((e, t, r, n, o) => {
            ...
            return r && (c.g = c[p]), a = c[p], g ? t.data = t.data.replace(g, a) : -1 === t.data.indexOf(a) && (t.data = n ? a + t.data : t.data + a), p
        })(o.unshift ? o.raw ? (t = [].slice.call(arguments, 1), r = n.p, o.reduce((e, n, o) => {
            let a = t[o];
            if (a && a.call) {
                let e = a(r),
                    t = e && e.props && e.props.className || /^go/.test(e) && e;
                a = t ? "." + t : e && "object" == typeof e ? e.props ? "" : u(e, "") : !1 === e ? "" : e
            }
            return e + n + (null == a ? "" : a)
        }, "")) : o.reduce((e, t) => Object.assign(e, t && t.call ? t(n.p) : t), {}) : o, (e => {
    ...
    var b = (e, t) => "function" == typeof e ? e(t) : e,
        ...
        k = {},
        A = (e, t = S) => {
            k[t] = _(k[t] || E, e), x.forEach(([e, r]) => {
                e === t && r(k[t])
            })
        },
        O = e => Object.keys(k).forEach(t => A(e, t)),
        C = (e = S) => t => {
            A(t, e)
        },
        j = {
        ...
        I = e => (t, r) => {
            ...
            return C(o.toasterId || (n = o.id, Object.keys(k).find(e => k[e].toasts.some(e => e.id === n))))({
                type: 2,
                toast: o
            }), o.id
        },
        P = (e, t) => I("blank")(e, t);
    P.error = I("error"), P.success = I("success"), P.loading = I("loading"), P.custom = I("custom"), P.dismiss = (e, t) => {
        let r = {
            type: 3,
            toastId: e
        };
        ...
        t ? C(t)(r) : O(r)
    }, P.removeAll = e => P.remove(void 0, e), P.promise = (e, t, r) => {
        let n = P.loading(t.loading, { ...r,
            ...null == r ? void 0 : r.loading
        });
        return "function" == typeof e && (e = e()), e.then(e => {
            let o = t.success ? b(t.success, e) : void 0;
            return o ? P.success(o, {
                id: n,
                ...r,
                ...null == r ? void 0 : r.success
            }) : P.dismiss(n), e
        }).catch(e => {
            let o = t.error ? b(t.error, e) : void 0;
            o ? P.error(o, {
                id: n,
                ...r,
...
`, W = ({
        ...
        return void 0 !== t ? "string" == typeof t ? o.createElement(V, null, t) : t : "blank" === r ? null : o.createElement(U, null, o.createElement($, { ...n
        }), "loading" !== r && o.createElement(F, null, "error" === r ? o.createElement(T, { ...n
        }) : o.createElement(z, { ...n
        })))
    }, B = h("div")
    `
...
`, Z = o.memo(({
        ...
        let a = e.height ? ((e, t) => {
                let r = e.includes("top") ? 1 : -1,
                    [n, o] = w() ? ["0%{opacity:0;} 100%{opacity:1;}", "0%{opacity:1;} 100%{opacity:0;}"] : [`
...
`];
                return {
                    animation: t ? `${y(n)} 0.35s cubic-bezier(.21,1.02,.73,1) forwards` : `${y(o)} 0.4s forwards cubic-bezier(.06,.71,.55,1)`
                }
            ...
            s = o.createElement(H, { ...e.ariaProps
            }, b(e.message, e));
    ...
    n = o.createElement, u.p = void 0, p = n, g = void 0, m = void 0;
    var Y = ({
            id: e,
            className: t,
            style: r,
...
`;
    e.s(["Toaster", 0, ({
        ...
        let {
            ...
            let {
                ...
                let [r, n] = (0, o.useState)(k[t] || E), a = (0, o.useRef)(k[t]);
                (0, o.useEffect)(() => (a.current !== k[t] && n(k[t]), x.push([t, n]), () => {
                    let e = x.findIndex(([e]) => e === t);
                    e > -1 && x.splice(e, 1)
                }), [t]);
            ...
            })(e, t), a = (0, o.useRef)(new Map).current, i = (0, o.useCallback)((e, t = q) => {
                if (a.has(e)) return;
                let r = setTimeout(() => {
                    a.delete(e), s({
                        type: 4,
            ...
            (0, o.useEffect)(() => {
                ...
                let e = Date.now(),
                    o = r.map(r => {
                        ...
                        return setTimeout(() => P.dismiss(r.id, t), n)
                    });
                return () => {
                    o.forEach(e => e && clearTimeout(e))
                }
            }, [r, n, t]);
            let s = (0, o.useCallback)(C(t), [t]),
                l = (0, o.useCallback)(() => {
                    s({
                        type: 5,
                        time: Date.now()
                ...
                d = (0, o.useCallback)((e, t) => {
                    let {
                        ...
                        gutter: o = 8,
                        defaultPosition: a
                    } = t || {}, i = r.filter(t => (t.position || a) === (e.position || a) && t.height), s = i.findIndex(t => t.id === e.id), l = i.filter((e, t) => t < s && e.visible).length;
                    return i.filter(e => e.visible).slice(...n ? [l + 1] : [0, l]).reduce((e, t) => e + (t.height || 0) + o, 0)
                }, [r]);
        ...
        return o.createElement("div", {
            ...
            return o.createElement(Y, {
                ...
                style: d
            }, "custom" === r.type ? b(r.message, r) : a ? a(r) : o.createElement(Z, {
                toast: r,
                position: l
            }))
        }))
    ...
    e.s(["v4", 0, function(e, a, i) {
        ...
        if (s[6] = 15 & s[6] | 64, s[8] = 63 & s[8] | 128, a) {
            if ((i = i || 0) < 0 || i + 16 > a.length) throw RangeError(`UUID byte range ${i}:${i+15} is out of buffer bounds`);
            for (let e = 0; e < 16; ++e) a[i + e] = s[e];
            return a
        }
    ...
    async function i() {
        ...
        return new Promise((t, r) => {
            let n = e.transaction(o, "readonly").objectStore(o).getAll();
            n.onsuccess = () => {
                t(n.result)
            }, n.onerror = () => {
    ...
    async function s(e) {
        ...
        return new Promise((r, n) => {
            let a = t.transaction(o, "readwrite").objectStore(o).add(e);
            a.onsuccess = () => {
                r()
            }, a.onerror = () => {
    ...
    async function l(e) {
        let t = await a();
        return new Promise((r, n) => {
            let a = t.transaction(o, "readwrite").objectStore(o).put(e);
            a.onsuccess = () => {
                r()
            }, a.onerror = () => {
    ...
    async function u(e) {
        let t = await a();
        return new Promise((r, n) => {
            let a = t.transaction(o, "readwrite").objectStore(o).delete(e);
            a.onsuccess = () => {
                r()
            }, a.onerror = () => {
    ...
    async function c(e) {
        let t = await a();
        return new Promise((r, n) => {
            let a = t.transaction(o, "readonly").objectStore(o).index("status").count(e);
            a.onsuccess = () => {
                r(a.result)
            }, a.onerror = () => {
    ...
    async function f(e, t = null) {
        ...
        return await s(o), window.dispatchEvent(new CustomEvent("sync-queue-updated")), r
    }
    async function p() {
    ...
    async function h(e, t) {
        ...
        r && (t ? await y(e) : (r.retryCount++, r.lastRetryAt = Date.now(), r.retryCount >= 5 ? r.status = "failed" : r.status = "retrying", await l(r), window.dispatchEvent(new CustomEvent("sync-queue-updated"))))
    }
    async function b() {
        ...
        processSyncQueue: async (n = null) => {
            if (!t().isSyncing) {
                ...
                try {
                    ...
                    for (let e of o) try {
                        let t = e.attempt;
                        await r.userApi.createAttempt(t), await y(e.id), a++
                    } catch (t) {
                        t instanceof Error && (t.message.includes("already exists") || t.message.includes("duplicate") || t instanceof r.ApiError && 409 === t.status) ? (console.log("Duplicate attempt detected, removing from queue:", e.id), await y(e.id), a++) : (await h(e.id, !1), i++, console.error("Failed to sync attempt:", t))
                    }
                    await t().refreshQueueStats(), e({
                        isSyncing: !1,
                        lastSyncAt: Date.now(),
                        lastSyncError: i > 0 ? `${i} attempt(s) failed to sync` : null
                    }), a > 0 && window.dispatchEvent(new CustomEvent("attempts-synced", {
                        detail: {
                            count: a
                        }
                    }))
    ...
    e.s(["AuthProvider", 0, function({
        ...
        let [h, b] = (0, r.useState)(null), [v, w] = (0, r.useState)(m), [S, _] = (0, r.useState)(!y), [x, E] = (0, r.useState)(!1), [k, A] = (0, r.useState)(!1), O = async () => {
            try {
        ...
        (0, r.useEffect)(() => {
            ...
            if (e) {
                let t = !1;
                return _(!0), E(!1), localStorage.removeItem("guestMode"), (async () => {
                    try {
                        await g(e.token);
                        let r = await u.userApi.syncUser();
                        if (t) return;
                        b(null), w(r), r.isNewUser && !localStorage.getItem(f) && A(!0)
                    } catch (e) {
                        console.error("Error bootstrapping test auth session:", e), t || w(null)
                    } finally {
                        t || _(!1)
                    }
                })(), () => {
            ...
            if (!s.hasConfig) return void _(!1);
            ...
            let t = (0, i.onAuthStateChanged)(s.auth, async e => {
                if (b(e), e) {
                    E(!1), localStorage.removeItem("guestMode");
                    try {
                        let e = await u.userApi.syncUser();
                        await O(), e.isNewUser && !localStorage.getItem(f) && A(!0)
                    } catch (e) {
        ...
        let C = async () => {
                if (!s.hasConfig) {
                    d.default.error("Authentication is unavailable in this environment"), _(!1);
                    return
                }
                try {
                    _(!0);
                    let e = await (0, o.signInWithPopup)(s.auth, s.googleProvider);
                    localStorage.removeItem("guestMode"), E(!1), setTimeout(async () => {
                        try {
            ...
            j = async () => {
                if ((0, l.getStoredTestAuthSession)()) {
                    (0, l.clearStoredTestAuthSession)(), b(null), w(null);
                    try {
                        await g(null)
                    } catch (e) {
                ...
                try {
                    await (0, a.signOut)(s.auth), b(null), w(null);
                    try {
                        await g(null)
                    } catch (e) {
            ...
            I = async () => {
                ...
                if (!h) return null;
                try {
                    return await h.getIdToken()
                } catch (e) {
                    return console.error("Error getting ID token:", e), null
                }
            },
            P = !!(h || v || (0, l.isTestAuthEnabled)() && (0, l.getStoredTestAuthSession)()) && !x;
        return (0, t.jsx)(p.Provider, {
            value: {
                ...
                signOut: j,
                continueAsGuest: () => {
                    E(!0), localStorage.setItem("guestMode", "true"), _(!1)
                },
                getIdToken: I,
                refreshBackendUser: O,
                dismissWelcomeSetup: () => {
                    A(!1), localStorage.setItem(f, "true")
                }
            },
            children: e
        })
    ...
    class d extends l.Component {
        getSnapshotBeforeUpdate(e) {
            ...
            if (t && e.isPresent && !this.props.isPresent) {
                ...
                o.height = t.offsetHeight || 0, o.width = t.offsetWidth || 0, o.top = t.offsetTop, o.left = t.offsetLeft, o.right = r - o.width - o.left, o.bottom = n - o.height - o.top
            }
            return null
        }
        componentDidUpdate() {}
    ...
    function f({
        ...
        return (0, l.useInsertionEffect)(() => {
            ...
            let d = "left" === o ? `left: ${l}` : `right: ${u}`,
                f = "bottom" === a ? `bottom: ${c}` : `top: ${r}`;
            p.current.dataset.motionPopId = s;
            let y = document.createElement("style");
            m && (y.nonce = m);
            let h = i ? ? document.head;
            return h.appendChild(y), y.sheet && y.sheet.insertRule(`
    ...
    e.s(["AnimatePresence", 0, ({
        ...
        let [v, w] = (0, m.usePresence)(d), S = (0, r.useMemo)(() => h(e), [e]), _ = d && !v ? [] : S.map(y), x = (0, r.useRef)(!0), E = (0, r.useRef)(S), k = (0, o.useConstant)(() => new Map), A = (0, r.useRef)(new Set), [O, C] = (0, r.useState)(S), [j, I] = (0, r.useState)(S);
        (0, a.useIsomorphicLayoutEffect)(() => {
            x.current = !1, E.current = S;
            for (let e = 0; e < j.length; e++) {
                let t = y(j[e]);
                _.includes(t) ? (k.delete(t), A.current.delete(t)) : !0 !== k.get(t) && k.set(t, !1)
            }
        }, [j, _.length, _.join("-")]);
        let P = [];
        if (S !== O) {
            ...
            for (let t = 0; t < j.length; t++) {
                let r = j[t],
                    n = y(r);
                _.includes(n) || (e.splice(t, 0, r), P.push(r))
            }
            return "wait" === c && P.length && (e = P), I(h(e)), C(S), null
        }
        let {
            forceRender: q
        ...
        return (0, t.jsx)(t.Fragment, {
            children: j.map(e => {
                let r = y(e),
                    n = (!d || !!v) && (S === j || _.includes(r));
                return (0, t.jsx)(p, {
                    isPresent: n,
                    initial: (!x.current || !!s) && void 0,
                    custom: i,
                    presenceAffectsLayout: u,
                    mode: c,
                    root: b,
                    onExitComplete: n ? void 0 : () => {
                        if (A.current.has(r) || (A.current.add(r), !k.has(r))) return;
                        k.set(r, !0);
                        let e = !0;
                        k.forEach(t => {
                            t || (e = !1)
                        }), e && (q ? .(), I(E.current), d && w ? .(), l && l())
                    },
                    anchorX: f,
                    anchorY: g,
                    children: e
    ...
    Object.defineProperty(r, "__esModule", {
        ...
        var e, t, r = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "",
            ...
            i = r || "";
        return o && (i = r.toString().trim().replace(/[A-Za-z0-9\u00C0-\u00FF]+[^\s-]*/g, function(e, t, r) {
        ...
        function t() {
            ...
            y(this, "reset", function() {
                ...
                if ("u" > typeof window && "u" > typeof document && !e._hasLoadedGA) {
                    ...
                    o.async = !0, o.src = "".concat(n, "?id=").concat(t), r && o.setAttribute("nonce", r), document.body.appendChild(o), window.dataLayer = window.dataLayer || [], window.gtag = function() {
                        window.dataLayer.push(arguments)
                    }, e._hasLoadedGA = !0
                }
            }), y(this, "_toGtagOptions", function(e) {
                if (e) {
                    var t = {
                    ...
                    return Object.entries(e).reduce(function(e, r) {
                        var n = function(e) {
                                ...
                                if (null != t) {
                                    ...
                                    try {
                                        o = (t = t.call(e)).next, !1;
                                        for (; !(s = (r = o.call(t)).done) && (i.push(r.value), 2 !== i.length); s = !0);
                                    } catch (e) {
                                        l = !0, n = e
                                    } finally {
                                        try {
                ...
                if (e._testMode = l, l || e._loadGA(e._currentMeasurementId, i, u), e.isInitialized || (e._gtag("js", new Date), n.forEach(function(t) {
                        var r = p(p(p({}, e._toGtagOptions(p(p({}, o), t.gaOptions))), a), t.gtagOptions);
            ...
            }), y(this, "_gaCommandSendEvent", function(t, r, n, o, a) {
                e._gtag("event", r, p(p({
                    event_category: t,
                    event_label: n,
                    value: o
            ...
            }), y(this, "_gaCommandSendTiming", function(t, r, n, o) {
            ...
            }), y(this, "_gaCommandSendPageview", function(t, r) {
                ...
                for (var t = arguments.length, r = Array(t), n = 0; n < t; n++) r[n] = arguments[n];
                "string" == typeof r[0] && (r[0] = y({}, r[0], r[1])), e._gtag("set", e._toGtagOptions(r[0]))
            }), y(this, "_gaCommand", function(t) {
    ...
    r.ReactGAImplementation = o.GA4, r.default = o.default
}, 375679, 657916, e => {
    "use strict";
    var t = e.i(68817);
    ...
    function a(e, r) {
        o && n("analytics") && t.default.event(e, r)
    }
    e.s(["initAnalytics", 0, function() {
        !o && n("analytics") && (t.default.initialize("G-SRDCQPNSQ2"), o = !0)
    ...
    }, "trackEvent", 0, a, "trackPaperLoad", 0, function(e, t) {
        a("paper_load", {
            subject_code: e,
            paper_id: t
        })
    ...
    function s(e) {
        var o;
        let s, l = (o = e, (s = t.forwardRef((e, n) => {
                let {
                    children: o,
                    ...s
                } = e;
                if (i(o) && "function" == typeof a && (o = a(o._payload)), t.isValidElement(o)) {
                    var l;
                    let e, a, i = (l = o, (a = (e = Object.getOwnPropertyDescriptor(l.props, "ref") ? .get) && "isReactWarning" in e && e.isReactWarning) ? l.ref : (a = (e = Object.getOwnPropertyDescriptor(l, "ref") ? .get) && "isReactWarning" in e && e.isReactWarning) ? l.props.ref : l.props.ref || l.ref),
                        u = function(e, t) {
                            let r = { ...t
                            };
                            for (let n in t) {
                    ...
                    return o.type !== t.Fragment && (u.ref = n ? (0, r.composeRefs)(n, i) : i), t.cloneElement(o, u)
                }
                return t.Children.count(o) > 1 ? t.Children.only(null) : null
            })).displayName = `${o}.SlotClone`, s),
            u = t.forwardRef((e, r) => {
                let {
                    children: o,
                    ...s
                ...
                if (d) {
                    let e = d.props.children,
                        o = u.map(r => r !== d ? r : t.Children.count(e) > 1 ? t.Children.only(null) : t.isValidElement(e) ? e.props.children : null);
                    return (0, n.jsx)(l, { ...s,
                        ref: r,
